...
> Repo: **viralefy_sender**
> Go, microserviço de borda, loopback-only. Envio de e-mail e notificações.
> Trate template e destinatário como dados não-confiáveis — escape, allowlist, rate-limit.
